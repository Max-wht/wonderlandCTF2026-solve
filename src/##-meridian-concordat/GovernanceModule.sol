...
contract GovernanceModule {
  ...
  function initialize(address _owner, address[] calldata _council, uint256 _quorum) external {
  ...
  function createProposal(address target, bytes calldata data, uint256 value)
    external
    onlyCouncil
    returns (uint256 id)
  {
